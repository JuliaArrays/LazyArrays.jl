...
macro _blasmatvec(Lay, Typ)
    esc(quote
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            A,B = M.factors
            LazyArrays.materialize!(LazyArrays.MulAdd(one(T), A, B, zero(T), dest))
        end
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            α,M = bc.args
            A,B = M.factors
            LazyArrays.materialize!(LazyArrays.MulAdd(α, A, B, zero(T), dest))
        end
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            M,C = bc.args
            A,B = M.factors
            copyto!(dest, LazyArrays.MulAdd(one(T), A, B, one(T), C))
        end
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            β,C = βc.args
            A,B = M.factors
            copyto!(dest, LazyArrays.MulAdd(one(T), A, B, β, C))
        end
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            α,M = αM.args
            A,B = M.factors
            copyto!(dest, LazyArrays.MulAdd(α, A, B, one(T), C))
        end
        ...
        @inline function LazyArrays._copyto!(::LazyArrays.AbstractStridedLayout, dest::AbstractVector{T},
            ...
            A,B = M.factors
            β,C = βc.args
            copyto!(dest, LazyArrays.MulAdd(α, A, B, β, C))
        end
    end)
end
