...
macro lazymul(Typ)
    ret = quote
        ...
        Base.:*(A::$Typ, B::LazyArrays.LayoutVector) = LazyArrays.apply(*,A,B)
    ...
    for Mod in (:Adjoint, :Transpose, :Symmetric, :Hermitian)
        ret = quote
            ...
            Base.:*(A::$Mod{<:Any,<:$Typ}, B::AbstractVector) = LazyArrays.apply(*,A,B)
            Base.:*(A::$Mod{<:Any,<:$Typ}, B::LazyArrays.LayoutMatrix, C...) = LazyArrays.apply(*,A,B, C...)
            Base.:*(A::$Mod{<:Any,<:$Typ}, B::LazyArrays.LayoutVector) = LazyArrays.apply(*,A,B)
            Base.:*(A::$Mod{<:Any,<:$Typ}, B::LazyArrays.LazyVector) = LazyArrays.apply(*,A,B)
...
macro lazyldiv(Typ)
    esc(quote
        ...
        Base.:\(A::$Typ, x::LazyArrays.LayoutVector) = LazyArrays.apply(\,A,x)
