...
@inline simplifiable(M::Mul{<:ApplyLayout{typeof(\)}, <:DiagonalLayout{<:AbstractFillLayout}}) = Val(true)
@inline simplifiable(M::Mul{ApplyLayout{typeof(\)}, <:DiagonalLayout{<:AbstractFillLayout}}) = Val(true) # need both this and the above
