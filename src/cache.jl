...
BroadcastStyle(::Type{<:AdjOrTrans{<:Any, <:SubArray{<:Any,1,<:AbstractCachedArray{<:Any,1}}}}) = CachedArrayStyle{1}()
BroadcastStyle(::Type{<:SubArray{<:Any,N,<:AbstractCachedArray{<:Any,M}}}) where {N,M} = CachedArrayStyle{M}()
BroadcastStyle(::Type{<:SubArray{<:Any,1,<:AbstractCachedArray{<:Any,1}}}) = CachedArrayStyle{1}()
